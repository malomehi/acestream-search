...
title = Acestream Search

# (str) Package name
package.name = acestreamsearch

# (str) Package domain (needed for android/ios packaging)
package.domain = com.malomehi
...
requirements = python3,kivy,adb-shell,beautifulsoup4,dnspython,portscan,python-dateutil,requests,tabulate,tzdata,git+https://github.com/malomehi/acestream-search.git@master
...
presplash.filename = acestream_search/gui/resources/tv.png

# (str) Icon of the application
icon.filename = acestream_search/gui/resources/tv.png
